...
- **Интеграция Миничат → Streamer.bot**
  ...
  - Для Streamer.bot версий от 1.0.0 и выше вам нужна [моя версия интеграции](https://t.me/nuboheimersb/702/), поскольку оригинальная с этими версиями работает некорректно.
...
- Игнорирование зрителя, написавшего в чат, до того как модуль пометил его "зашедшим впервые".
- Очистка списка "пришедших" зрителей.
- Получение списка текущих платных подписчиков Twitch через Helix API.
